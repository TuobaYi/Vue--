<template>
  <div class="ratings">
    <div class="ratings-content">
      <div class="overview">
        ...
        <div class="overview-right">
          <div class="score-wrapper">
            ...
            <stars-list :rating="info.serviceScore" size="36"></stars-list>
      ...
      <rating-filter  :selectType="selectType"
          ...
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                <stars-list :rating="info.serviceScore" size="24"></stars-list>
...
<script>
  ...
  import RatingFilter from '../../../../components/RatingsFilter/RatingsFilter';
  export default {
    name: 'retings',
    data(){
      return{
        onlyContent: true, // 是否只显示有内容的  text
        selectType: 2, // 2: 全部, 1: 不满意, 0: 满意  rateType
      }
    },
    computed:{
     ...
     /* filterRatings(){
        const {ratings, onlyContent, selectType} = this
        return ratings.filter(()=>{//整体判断逻辑  从上向下 最上层的两个过滤
          const {rateType, text} = rating;
