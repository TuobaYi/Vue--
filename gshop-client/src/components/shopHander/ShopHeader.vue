<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content"  @click="isShowInfo=true">
        ...
        <div class="shop-message" v-if="info.pics">
          <span class="shop-message-detail">{{info.pics.length}}</span>
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowSupport=true">
      <div class="discounts-left">
        <div class="activity" :class="supportColor[info.supports[0].type]">
          <span class="content-tag">
      ...
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item"
              ...
              :key="index" :class="supportColor[support.type]">
            <span class="content-tag">
        ...
        <div class="activity-sheet-close" @click="isShowSupport=false">
          <span class="iconfont icon-close" style="display: inline-block">×</span>
        </div>
      </div>
